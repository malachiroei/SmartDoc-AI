...
export const he = {
  ...
  scanner: {
    ...
    placeDocument: "אנא מקמו את המסמך במרכז",
    locked: "המסמך זוהה — מוכן ליישור",
    fullPage: "📄 עמוד מלא",
  ...
  camera: {
    ...
    dragHint: "גררו את הנקודות לכוונון ידני",
    placeDocument: "אנא מקמו את המסמך במרכז המסגרת",
    locked: "המסמך זוהה — מוכן ליישור",
    adjusting: "גררו את הפינות לתיקון פרספקטיבה",
  },
  filters: {
    enhance: "אוטומטי",
    original: "מקורי",
  ...
  errors: {
    ...
    timeout:
      "השרת חרג מזמן ההמתנה (504). סריקת המייל מוגבלת לכמה קבצים בכל פעם — נסו שוב להמשך.",
  ...
  gmail: {
    ...
    ingestTimeout:
      "סריקת המייל נקטעה בגלל מגבלת זמן. לחצו שוב — בכל פעם מעבדים עד 2 קבצים חדשים.",
